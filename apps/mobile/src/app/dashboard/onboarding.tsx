...
export const Onboarding = () => {
    ...
    return (
        <View className="mx-4 mb-4 p-4 border border-primary bg-background shadow-md shadow-primary/20">
            ...
            <View style={{ display: isMinimized ? "none" : "flex" }}>
                <View className="flex flex-col gap-4">
                    <View className="flex-row gap-3">
                        ...
                        <View className="flex-1 flex-col">
                            ...
                            <Text className="text-xs text-muted-foreground leading-4 mt-1">
                                Go to "Categories" tab to create your first Area
                                and Subarea.
                            </Text>
                        </View>
                    </View>
                    ...
                    <View className="h-px bg-foreground/10 my-1 w-full" />
                    <Text className="text-[10px] text-foreground/40 font-mono uppercase tracking-widest">
                        Optional Setup
                    </Text>
