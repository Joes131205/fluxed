...
export const SubareaSection = ({
    ...
    if (!subareas.length) {
        return (
            <View className="mt-4 pt-4 border-t-2 border-dashed border-primary/10">
    ...
    return (
        <View className="mt-4 pt-4 border-t-2 border-dashed border-primary/10 flex flex-row flex-wrap gap-3">
            {subareas.map((subarea) => {
                ...
                return (
                    <View
                        ...
                        className="border border-primary/20 px-3 py-2 min-w-30 flex"
                    >
                        <View className="flex flex-col gap-3 items-center justify-center">
                                ...
                                {[...new Array(5)].map((_, i) => {
                                    ...
                                    return (
                                        <View
                                            ...
                                            className={`h-2 w-2 border ${isActive ? "border-transparent" : "border-primary/20"}`}
                                            style={{
                            ...
                            <Pressable
                                ...
                                className="px-2 py-2 border border-primary/20 active:bg-primary/10 ml-2"
                            >
                                <Text
