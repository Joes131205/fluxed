        ...
        <View className="flex flex-col mt-2">
            ...
            {isGoogleConnected && (
                <View className="border border-primary/20 p-4 mb-4">
                    <Text className="text-muted-foreground font-mono uppercase mb-4 text-xs">
            ...
            <View className="flex flex-col mb-4">
                <Text className="text-muted-foreground font-mono text-[10px] uppercase mb-2">
                    Inject Manual Block
                </Text>
            ...
            {calendar.length > 0 && (
                <View className="flex flex-col gap-2 mt-2 border-t border-primary/10 pt-4">
                        ...
                        <View key={item.id} className="flex flex-col">
                            {item.busy.length > 0 &&
                                item.busy.map((slot: any, index: number) => (
                                    <View
                                        key={`${item.id}-${index}`}
                                        className="flex-row items-center justify-between border-b border-primary/10 py-2"
                                    >
                                        ...
                                        {item.id === "offline" && (
                                            <Pressable
                                                ...
                                                className="border border-primary/20 px-2 py-1 active:bg-destructive/20"
                                            >
